        ...
        <div className="flex flex-col md:gap-10 gap-[120px] items-center justify-start w-full">
          <div className="flex flex-col md:gap-10 gap-[100px] items-start justify-start max-w-[1112px] mx-auto md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row font-opensans md:gap-10 gap-[99px] items-start justify-start w-[87%] md:w-full">
              <Button className="bg-gray-900 flex h-[50px] items-center justify-center mb-[843px] p-[15px] rounded-[50%] w-[50px]">
                <Img
                  className="h-4"
              ...
              <div className="bg-white-A700 flex flex-col items-center justify-start p-[46px] md:px-10 sm:px-5 rounded-[16px] shadow-bs4 w-[85%] md:w-full">
                <div className="flex flex-col gap-8 items-center justify-start w-full">
                  ...
                  <div className="flex flex-col font-poppins gap-8 items-center justify-start w-full">
                    <div className="flex flex-col gap-3.5 items-start justify-start rounded-lg w-full">
                      ...
                      <div className="flex sm:flex-col flex-row gap-4 items-center justify-between rounded-lg w-full">
                        <Input
                          ...
                          className="p-0 placeholder:text-gray-900 sm:pr-5 text-base text-gray-900 text-left w-full"
                          wrapClassName="bg-white-A700 border border-gray-400 border-solid sm:flex-1 pl-4 pr-[35px] py-4 rounded-lg sm:w-full"
                        ></Input>
                        <Button
                          className="common-pointer bg-indigo-300 cursor-pointer min-w-[166px] py-[15px] rounded-lg text-center text-lg text-white-A700"
                        ...
                        <div className="flex flex-col gap-6 items-center justify-start w-full">
                          <div className="flex sm:flex-col flex-row gap-4 items-center justify-between w-full">
                            <Input
                              ...
                              wrapClassName="bg-white-A700 border border-gray-400 border-solid sm:flex-1 pl-[23px] pr-[35px] py-[17px] rounded-lg sm:w-full"
                              type="text"
                            ></Input>
                            <Input
                          ...
                          <div className="flex md:flex-col flex-row gap-4 items-center justify-between w-full">
                            ...
                            <Input
                              ...
                              className="p-0 placeholder:text-gray-500 sm:px-5 text-base text-gray-500 text-left w-full"
                              wrapClassName="bg-white-A700 border border-gray-400 border-solid md:flex-1 pl-[23px] pr-[35px] py-[17px] rounded-lg md:w-full"
                              type="email"
                            ></Input>
                          </div>
                          <TextArea
                    ...
                    <Button className="bg-red-400 cursor-pointer font-medium min-w-[722px] md:min-w-full py-[19px] rounded-[12px] text-center text-white-A700 text-xl">
                      Order now
                    </Button>
                  </div>
                </div>
