    ...
    <>
      <div className="bg-gray-50 flex flex-col font-poppins items-center justify-start mx-auto w-full">
          ...
          <div className="flex flex-col md:gap-10 gap-[70px] items-center justify-start max-w-[1240px] mb-5 mx-auto w-full">
            <header className="flex items-center justify-center w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-center w-full">
                ...
                <Button
                  className="bg-white-A700 cursor-pointer flex h-[50px] sm:hidden items-center justify-center md:ml-[0] ml-[122px] rounded-[50%] w-[50px]"
                  leftIcon={
                    <Img
        ...
        <div className="flex flex-col items-center justify-start max-w-[1112px] mt-[156px] mx-auto md:px-5 w-full">
          ...
          <Button className="bg-red-400 cursor-pointer font-poppins font-semibold min-w-[235px] mt-[83px] py-[27px] rounded-[16px] text-center text-white-A700 text-xl">
            View all
          </Button>
        </div>
